...
$sql="update  tblbooks set BookName=:bookname,CatId=:category,AuthorId=:author,Serial_ID=:isbn,BookPrice=:price where id=:bookid";
...
<div class="form-group">
<label>Serial ID<span style="color:red;">*</span></label>
<input class="form-control" type="text" name="isbn" value="<?php echo htmlentities($result->Serial_ID);?>"  required="required" />
<p class="help-block">Unique Book number, used to serialize co-operative university Books</p>
</div>

 <div class="form-group">
 <label>Price in Ksh<span style="color:red;">*</span></label>
